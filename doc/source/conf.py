...
# -*- coding: utf-8 -*-
#
# Documentation GCsystem documentation build configuration file, created by
...
project = 'Documentation GCsystem'
copyright = '2015, fabsgc'
author = 'fabsgc'
...
htmlhelp_basename = 'DocumentationGCsystemdoc'
...
latex_documents = [
  (master_doc, 'DocumentationGCsystem.tex', 'Documentation GCsystem Documentation',
   'fabsgc', 'manual'),
]
