...
<form method="post" action="">
	...
	<input type="text" id="enigma.answer" name="enigma.answer" value="{$request->points}"/><br />
    <label for="enigma.points">Nombre de points</label>
    <input type="text" id="enigma.points" name="enigma.points" value="{$request->answer}"/><br />
